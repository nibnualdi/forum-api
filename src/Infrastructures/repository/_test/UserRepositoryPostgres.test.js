...
describe('UserRepositoryPostgres', () => {
  ...
  describe('verifyAvailableUsername', () => {
    it('should throw InvariantError when username not available', async () => {
      // Arrange
      await UsersTableTestHelper.addUser({ username: 'dicoding' }); // memasukan user baru
  ...
  describe('addUser function', () => {
    ...
    it('should return registered user correctly', async () => {
      ...
      const fakseIdGenerator = () => '123'; // stub!
      const userRepositoryPostgres = new UserRepositoryPostgres(pool, fakseIdGenerator);
